...
class ShareService {
  static const String baseUrl = 'https://playerpath.app';
  static const String appName = 'PlayerPath';
  ...
  static Future<void> shareProfile({
    ...
    final url = '$baseUrl/player/$slug';
    final text = '''
🏆 Check out this football profile on PlayerPath!
...
''');
  ...
  static Future<void> downloadCV({
    ...
    pdf.addPage(
      pw.MultiPage(
        ...
        build: (context) => [
          ...
          pw.Text('Generated by PlayerPath • $url', style: pw.TextStyle(fontSize: 9, color: PdfColors.grey400)),
        ],
      ),
    );
    ...
    await Printing.layoutPdf(
      onLayout: (_) => pdf.save(),
      name: '${playerName.replaceAll(' ', '_')}_PlayerPath_CV.pdf',
    );
  }
